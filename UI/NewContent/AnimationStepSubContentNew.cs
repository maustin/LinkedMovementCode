...
namespace LinkedMovement.UI.NewContent {
    internal class AnimationStepSubContentNew : IDoGUI {
        ...
        public AnimationStepSubContentNew(LMAnimationParams animationParams, LMAnimationStep animationStep, int stepIndex) {
            ...
            if (staringCustomColors != null) {
                ...
                for (int i = 0; i < numCustomColors; i++) {
                    customTextures.Add(Texture2DPool.GetTexture());
                }
            }
        }
